  ...
  return (
    <section className="section section--contacto" id="contacto">
      ...
      <div className="section-inner">
        ...
        <motion.div className="contacto-cta" {...fadeUp(1)}>
          <a
            href="https://wa.me/51915175071?text=Hola%2C%20me%20interesa%20saber%20más%20sobre%20sus%20servicios"
            target="_blank"
            rel="noreferrer"
          ...
          <p className="contacto-cta-hint">Respondemos en minutos · Lunes a viernes, 9am – 7pm</p>
        </motion.div>

        <motion.div className="contacto-info-card" {...fadeUp(2)}>
          <a
